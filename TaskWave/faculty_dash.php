...
<head>
    ...
    <style>
        ...
        header .navbar-brand img {
            margin-left: 30px; /* Adjust space between the icon and the text */
        }
    ...
    <main class="container main-content">
        ...
        <div class="row w-100">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center mb-4">
                <div class="card w-75 mb-4" onclick="window.location.href='faculty_profile.php';">
                ...
                <div class="card w-75 mb-4" onclick="window.location.href='faculty_status.php';">
                    <div class="card-body text-center">
                        <h5 class="card-title d-flex align-items-center justify-content-center">
            ...
            <!-- Second Row -->
            <div class="col-md-6 d-flex flex-column align-items-center mb-4">
                <div class="card w-75 mb-4" onclick="window.location.href='faculty_Passign.html';">
                    <div class="card-body text-center">
                        <h5 class="card-title d-flex align-items-center justify-content-center">
                            <i class="bi bi-file-earmark-text" style="font-size: 2rem;"></i>
                        </h5>
                        <h5 class="card-title">Post Assignments</h5>
                    </div>
                </div>
                <div class="card w-75 mb-4" onclick="window.location.href='faculty_timetable.html';">
                    <div class="card-body text-center">
                        <h5 class="card-title d-flex align-items-center justify-content-center">
...
<script>
    function redirectToDashboard() {
        window.location.href = 'faculty_login_form.php';
    }
</script>
</body>
</html>
